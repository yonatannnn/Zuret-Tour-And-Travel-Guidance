...
let ExpenseController = class ExpenseController {
    ...
    async addcars(carCompanyId, carBrand, carImagePath, carPrice) {
...
__decorate([
    ...
    __param(1, (0, common_1.Body)('prodId')),
    __param(2, (0, common_1.Body)('reason')),
    __param(3, (0, common_1.Body)('price')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, String, Number]),
    __metadata("design:returntype", Promise)
], ExpenseController.prototype, "addcars", null);
__decorate([
    (0, common_1.Get)(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], ExpenseController.prototype, "getAllCars", null);
__decorate([
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", Promise)
], ExpenseController.prototype, "getCarById", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], ExpenseController.prototype, "deleteCar", null);
